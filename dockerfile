...
# Description:      A set of tools written in bash and C++ for working with fastx_toolkit files
...
# Run Cmd:          docker run -it tareasbioinfinvrepro2016-ii/fastx_toolkit fastx_toolkit-0.0.14
#################################################################
